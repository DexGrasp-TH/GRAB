...
def visualize_sequences(cfg):
    ...
    choice = np.random.choice(len(all_seqs), 1, replace=False)  # 10 -> 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--grab-path", required=True, type=str, help="The path to the downloaded grab data")

    parser.add_argument("--model-path", required=True, type=str, help="The path to the folder containing smplx models")
